...
export function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 border-t border-zinc-200 bg-white/90 backdrop-blur dark:border-[#3a2a0c] dark:bg-[#0f0a03]/90 sm:hidden">
            ...
            >
              {href === "/profile" && user ? (
                user.avatar_url ? (
                  ...
                  <span className={cn("grid size-6 place-items-center rounded-full bg-gradient-to-br from-amber-500 to-yellow-400 text-[10px] font-black text-white", active && "ring-2 ring-amber-400 ring-offset-1")}>
